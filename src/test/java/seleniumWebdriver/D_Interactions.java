...
public class D_Interactions {
    ...
    public void enterTextIntoTheElement() {
        ...
        bookTitle.sendKeys("Harry Potter");
        WebElement movieTitle = driver.findElement(By.id("movie-text"));
        movieTitle.sendKeys("Szklana Pułapka");
...
//        doNothingButtonById.click();
        ...
        WebElement number3 = driver.findElement(By.xpath("//*[@id='number-radio']/span[3]")).findElement(By.xpath("//*[@id='number-radio']/span[3]/input"));
        number3.click();

        WebElement greenColour = driver.findElement(By.xpath("//*[@id='colour-select-multiple']")).findElement(By.xpath("//*[@id='colour-select-multiple']/option[3]"));
        greenColour.click();
        //driver.quit();
    }
